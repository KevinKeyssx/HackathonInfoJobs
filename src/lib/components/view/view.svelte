...
<div class="flex w-11/12">
    <div class="shadow-xl rounded px-8 py-6">
        <div class="mb-4"> 
            ...
            <!-- <h2>Información</h2> -->
            <span class="chip variant-filled-primary mt-2">En {city}</span>
            <span class="chip variant-filled-primary mt-2">Contrato {typeOfContract}</span>
            <span class="chip variant-filled-primary mt-2">Jornada {workingDay}</span>
            <span class="chip variant-filled-primary mt-2">{modality}</span>
            <span class="chip variant-filled-primary mt-2">{level}</span>
            <span class="chip variant-filled-primary mt-2">{getStaffInCharge(staff)}</span>
            <span class="chip variant-filled-primary mt-2">{vacancies} vacante(s)</span>
            <span class="chip variant-filled-primary mt-2">{getSalary( salary )}</span>
    ...
    <div class="flex w-11/12">
        <div class="shadow-xl rounded px-8 py-6 ">
            <div class="mb-4">
                ...
                <div class="w-[500px] overflow-hidden mt-1">
                    <p class="overflow-wrap-break-word whitespace-pre-wrap">
                        {@html description?.prompt || "Sin descripción"}
                    </p>
                </div>
                ...
                {#if customInfo && customInfo.length > 0}
                    <h3 class="mt-2">Material digital</h3>
